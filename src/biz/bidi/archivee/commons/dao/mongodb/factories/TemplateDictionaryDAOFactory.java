 ...
 * @since Oct 8, 2012
 */
public class TemplateDictionaryDAOFactory extends ArchiveeSingletonFactory<IArchiveeGenericDAO<TemplateDictionary, Query<TemplateDictionary>, Key<TemplateDictionary>>, Object> {
	 ...
	 */
	@Override
	public IArchiveeGenericDAO<TemplateDictionary, Query<TemplateDictionary>, Key<TemplateDictionary>> createInstance(
			Object object) throws ArchiveeException {
		if(instance == null) {
			instance = new TemplateDictionaryDAO();
		}
